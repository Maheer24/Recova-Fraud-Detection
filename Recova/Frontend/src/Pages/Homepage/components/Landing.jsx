...
export default function Landing() {
  ...
  return (
    <div className="bg-white dark:bg-[#212121] z-40 ">
...
<div
  ...
  className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-blue-200 to-indigo-300 dark:from-blue-900 dark:to-indigo-900 opacity-20 dark:opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
/>
</div>
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-blue-200 to-indigo-300 dark:from-blue-900 dark:to-indigo-900 opacity-20 dark:opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
      </div>
    </div>
